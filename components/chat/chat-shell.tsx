...
export function ChatShell() {
  ...
  return (
    <div
      ...
      style={{
        background: "linear-gradient(180deg, #ffffff 0%, #f0f7ff 50%, #e0efff 100%)",
      }}
    >
      <Button
        onClick={clearChat}
        variant="ghost"
        size="icon"
        className="absolute top-4 left-4 z-20 h-10 w-10 rounded-full bg-blue-50 hover:bg-blue-100 text-blue-600"
